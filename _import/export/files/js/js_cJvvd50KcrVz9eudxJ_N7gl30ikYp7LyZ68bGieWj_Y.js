Drupal.locale = { 'pluralFormula': function ($n) { return Number(($n!=1)); }, 'strings': {"":{"Disabled":"מבוטל", "Enabled":"מופעל", "Not published":"טרם פורסם", "Edit":"עדכן", "Unspecified error":"שגיאה לא ידועה", "Drag to re-order":"גרור לסידור", "Changes made in this table will not be saved until the form is submitted.":"שינויים בטבלה זו לא ישמרו עד לשליחת הטופס.", "Select all rows in this table":"בחר את כל השורות בטבלה", "Deselect all rows in this table":"בטל בחירת כל השורות בטבלה"}} };;
